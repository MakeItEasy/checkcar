class Back::SystemAdminsController < BackController
  ...
  ## 面包屑导航
  add_breadcrumb SystemAdmin.model_name.human, :back_system_admins_path
  ...
  def index
    ...
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.list'), :back_system_admins_path
  end
  ...
  def show
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.show'), :back_system_admin_path
  end
  ...
  def new
    ...
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.new'), :new_back_system_admin_path
  end

  # GET /system_admins/1/edit
  def edit
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.edit'), :edit_back_system_admin_path
  end
  ...
  def create
    ...
    respond_to do |format|
      if @system_admin.save
        format.html { redirect_to [:back, @system_admin], notice: I18n.t('view.notice.created') }
  ...
  def update
    respond_to do |format|
      ...
      if update_resource(@system_admin, system_admin_params)
        format.html { redirect_to [:back, @system_admin], notice: I18n.t('view.notice.updated') }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to back_system_admins_url, notice: I18n.t('view.notice.deleted') }
