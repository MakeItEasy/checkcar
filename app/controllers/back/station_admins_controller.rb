class Back::StationAdminsController < BackController
  ...
  ## 面包屑导航
  add_breadcrumb StationAdmin.model_name.human, :back_station_admins_path
  ...
  def index
    ...
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.list'), :back_station_admins_path
  end
  ...
  def show
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.show'), :back_station_admin_path
  end
  ...
  def new
    ...
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.new'), :new_back_station_admin_path
  end

  # GET /station_admins/1/edit
  def edit
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.edit'), :edit_back_station_admin_path
  end
  ...
  def create
    ...
    respond_to do |format|
      if @station_admin.save
        format.html { redirect_to [:back, @station_admin], notice: I18n.t('view.notice.created') }
  ...
  def update
    respond_to do |format|
      ...
      if update_resource(@station_admin, station_admin_params)
        format.html { redirect_to [:back, @station_admin], notice: I18n.t('view.notice.updated') }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to back_station_admins_url, notice: I18n.t('view.notice.deleted') }
