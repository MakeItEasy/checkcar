class Back::System::StationAdminsController < Back::SystemBaseController
  ...
  ## 面包屑导航
  add_breadcrumb StationAdmin.model_name.human, :back_system_station_admins_path

  # GET /station_admins
  # GET /station_admins.json
  def index
    @station_admins_grid = initialize_grid(StationAdmin)
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.list'), :back_system_station_admins_path
  end
  ...
  def show
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.show'), :back_system_station_admin_path
  end
  ...
  def new
    ...
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.new'), :new_back_system_station_admin_path
  end

  # GET /station_admins/1/edit
  def edit
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.edit'), :edit_back_system_station_admin_path
  end
  ...
  def create
    ...
    respond_to do |format|
      if @station_admin.save
        format.html { redirect_to [:back, :system, @station_admin], notice: I18n.t('view.notice.created') }
  ...
  def update
    respond_to do |format|
      ...
      if update_resource(@station_admin, station_admin_params)
        format.html { redirect_to [:back, :system, @station_admin], notice: I18n.t('view.notice.updated') }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to back_system_station_admins_url, notice: I18n.t('view.notice.deleted') }
