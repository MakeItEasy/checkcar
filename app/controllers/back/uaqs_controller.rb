class Back::UaqsController < BackController
  ...
  ## 面包屑导航
  add_breadcrumb Uaq.model_name.human, :back_uaqs_path
  ...
  def index
    ...
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.list'), :back_uaqs_path
  end
  ...
  def show
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.show'), :back_uaq_path
  end

  # GET /uaqs/1/edit
  def edit
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.answer'), :edit_back_uaq_path
  end
  ...
  def update
    ...
    respond_to do |format|
      if @uaq.update(uaq_params)
        format.html { redirect_to [:back, @uaq], notice: I18n.t('view.notice.updated') }
