class Back::CatagoriesController < BackController
  ...
  ## 面包屑导航
  add_breadcrumb Catagory.model_name.human, :back_catagories_path
  ...
  def index
    ...
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.list'), :back_catagories_path
  end
  ...
  def new
    ...
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.new'), :new_back_catagory_path
  end

  # GET /catagories/1/edit
  def edit
    ## 面包屑导航
    add_breadcrumb I18n.t('view.action.edit'), :edit_back_catagory_path
  end
  ...
  def create
    ...
    respond_to do |format|
      if @catagory.save
        format.html { redirect_to [:back, @catagory], notice: I18n.t('view.notice.created') }
  ...
  def update
    respond_to do |format|
      ...
      if @catagory.update_attributes(catagory_params)
        format.html { redirect_to [:back, @catagory], notice: I18n.t('view.notice.updated') }
